...
export async function setMainPhoto(photo) {
  ...
  try {
    ...
    const userFollowinSnap = await userFollowingRef.get();
    userFollowinSnap.docs.forEach((docRef) => {
...
// If there is an error on any request, cancel all 4 operation with batch for data consistency
